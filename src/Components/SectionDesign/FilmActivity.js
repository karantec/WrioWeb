...
export default function FilmEventPublicity() {
  const [isVisible, setIsVisible] = useState(false);
  useEffect(() => setIsVisible(true), []);

  // 🌟 HERO CONTENT
  const heroContent = {
    tag: "Lights. Camera. Publicity.",
    title: "Film / Event Publicity",
    subtitle:
      "Every event or film deserves the right spotlight. Cube handles complete publicity across media, influencers, and digital platforms.",
    description:
      "We bring stories to life through strategic publicity, connecting your event or film with the right audience and platforms for maximum buzz.",
    features: [
      "Celebrity & Event PR",
  ...
  const whyItMatters = {
    tag: "Why It Matters",
    title: "Publicity That Drives Attention",
    description:
      "Strategic publicity amplifies your message, generates excitement, attracts press, and maximizes audience engagement — before, during, and after your release or event.",
  };

  const processSteps = [
    {
      step: "01",
      title: "Understand Film or Event Objective",
      description:
        "We begin with understanding your goals, audience, and desired outcomes to design a tailored publicity strategy.",
      icon: Film,
    },
    {
      step: "02",
      title: "Plan PR and Influencer Activities",
      description:
        "Our PR experts and influencer managers coordinate media and digital promotions that align with your vision.",
      icon: Users,
    },
    {
      step: "03",
      title: "Create & Distribute Press Releases",
      description:
        "We craft and distribute impactful press content across verified media networks and entertainment platforms.",
      icon: Newspaper,
    },
    {
      step: "04",
      title: "Coordinate Social Campaigns & Coverage",
      description:
        "Our digital team manages online promotions, hashtags, and influencer engagement for viral visibility.",
      icon: Mic,
    },
    {
      step: "05",
      title: "Monitor & Report Performance",
      description:
        "We track coverage, impressions, and audience response — delivering complete post-campaign analytics.",
      icon: BarChart,
    },
  ];
  ...
  const whyChooseUs = {
    ...
    points: [
      "Handled multiple celebrity and event promotions.",
      "PR and influencer coordination under one team.",
      "Strong network across entertainment media.",
    ],
  };

  const caseStudy = {
    tag: "Case Study Snapshot",
    client: "Srabanti Chatterjee (Film Publicity)",
    challenge: "Needed maximum visibility for film release.",
    strategy:
      "Executed coordinated media and influencer promotions before and during the film’s release period.",
    result: "Achieved 1M+ organic mentions within the first week.",
  };

  const faqs = [
    {
      q: "Can you handle on-ground events?",
      a: "Yes, our team provides complete event coordination including media, PR, and influencer management.",
    },
    {
      q: "Do you manage media invites?",
      a: "Absolutely — we handle invitations for press, influencers, and entertainment journalists.",
    },
  ];

  const cta = {
    icon: Sparkles,
    title: "Lights, Camera, Coverage!",
    subtitle: "Make your film or event unforgettable with Cube Multimedia.",
    buttonText: "Start My Publicity Campaign",
  };
          ...
          <div className="flex-1">
            <div className="relative bg-white/95 backdrop-blur-lg text-gray-900 p-8 rounded-3xl shadow-2xl border border-white/20 hover:shadow-rose-500/20 transition-all duration-500">
              ...
              <p className="text-gray-600 text-sm text-center mb-6">
                Get your event or film the spotlight it deserves.
              </p>

              <form className="space-y-4">
                {["Email", "Project Type", "Location"].map((ph, i) => (
                  <input
                    key={i}
                    type="text"
                    placeholder={ph}
