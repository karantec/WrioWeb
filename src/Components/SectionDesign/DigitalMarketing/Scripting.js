...
export default function Scripting() {
  ...
  // 🌟 Hero content
  const heroContent = {
    tag: "Stories that inspire action.",
    title: "Scriptwriting & Storyboarding",
    subtitle:
      "Every great video starts with a great script. Cube turns ideas into structured stories that connect with emotion and intent.",
    description:
      "At Cube Multimedia, we craft powerful scripts and storyboards that give your videos purpose, clarity, and emotion — turning raw ideas into compelling narratives that engage audiences.",
    features: [
  ...
  const whyItMatters = {
    tag: "Why It Matters",
    title: "A Strong Script Gives Content Purpose",
    description:
      "Without clarity, content fails. A strong script ensures every second has flow, impact, and emotional intent — it’s the blueprint of every successful video.",
  };

  const processSteps = [
    {
      step: "01",
      title: "Brief Discussion & Goal Analysis",
      description:
        "We begin by understanding your vision, goals, and target audience to define the creative direction.",
      icon: FileText,
    },
    {
      step: "02",
      title: "Story Idea & Format Selection",
      description:
        "Our team develops the core idea, selects tone and structure, and determines the ideal storytelling format.",
      icon: Lightbulb,
    },
    {
      step: "03",
      title: "Scriptwriting & Dialogue Creation",
      description:
        "Professional writers craft engaging scripts with natural dialogue and emotional resonance.",
      icon: PenTool,
    },
    {
      step: "04",
      ...
      description:
        "We translate your script into visual scenes, defining camera shots, tone, and transitions for clear execution.",
      icon: Layout,
    },
    {
      step: "05",
      title: "Final Handover with Creative Notes",
      description:
        "You receive a refined script and storyboard with creative notes ready for production.",
      icon: FileCheck,
    },
  ];
  ...
  const whyChooseUs = {
    ...
    points: [
      "Writers experienced in ads, podcasts, and brand videos.",
      "Balanced approach between storytelling and marketing goals.",
      "Faster turnaround with creative clarity.",
    ],
  };
  ...
  const caseStudy = {
    ...
    challenge: "Needed structured storytelling for interviews.",
    strategy: "Developed a conversational yet cinematic script format.",
    result: "Improved audience retention and stronger brand identity.",
  };

  const faqs = [
    {
      q: "Do you write in Bangla or English?",
      a: "Both languages are available based on project requirements.",
    },
    {
      q: "Can I request changes after delivery?",
      a: "Yes, one round of revision is included after script delivery.",
    },
  ];

  const cta = {
    icon: Sparkles,
    title: "Your Brand Deserves Better Storytelling",
    subtitle: "Start your creative journey with Cube Multimedia today.",
    buttonText: "Start My Script Project",
  };
