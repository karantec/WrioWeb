...
export default function Graphic() {
  ...
  // 🌟 Hero content
  const heroContent = {
    tag: "Design that speaks volumes.",
    title: "Graphic Design",
    subtitle:
      "Every visual tells a story — we design with meaning. From social media to brand collateral, Cube creates designs that leave impact.",
    description:
      "Cube Multimedia crafts visually striking, emotionally resonant designs that enhance your brand identity and ensure consistency across all media.",
    features: [
  ...
  const whyItMatters = {
    tag: "Why It Matters",
    title: "Design Builds Recognition and Trust",
    description:
      "A strong visual identity makes your brand memorable and consistent. Good design turns casual audiences into loyal customers by conveying your message clearly and beautifully.",
  };
  ...
  const processSteps = [
    {
      ...
      description:
        "We begin by studying your brand tone, colors, and target audience to ensure creative alignment.",
      icon: FileText,
    },
    {
      step: "02",
      title: "Concept Sketches & Creative Direction",
      description:
        "Our team brainstorms ideas and sketches multiple concepts to explore unique visual directions.",
      icon: PenTool,
    },
    {
      step: "03",
      title: "Design & Review",
      description:
        "We craft polished visuals that align with your goals and share them for review and approval.",
      icon: Layout,
    },
    {
      step: "04",
      ...
      description:
        "We refine designs based on your feedback to achieve the perfect creative balance.",
      icon: RefreshCcw,
    },
    {
      step: "05",
      ...
      description:
        "You receive high-quality, ready-to-use files optimized for digital and print use.",
      icon: FileCheck,
    },
  ];
  ...
  const caseStudy = {
    ...
    client: "Cube Multimedia",
    challenge: "Needed rebranding for multiple service verticals.",
    strategy: "Redesigned logo templates and established visual consistency.",
    result: "Stronger brand recall and a more professional, unified look.",
  };

  const faqs = [
    {
      q: "Do you create print designs?",
      a: "Yes, we design flyers, brochures, banners, and other print materials.",
    },
    {
      q: "Can I get editable files?",
      a: "Yes, source files can be provided upon request.",
    },
  ];

  const cta = {
    icon: Sparkles,
    title: "Your Design Defines Your Brand",
    subtitle:
      "Let Cube Multimedia elevate your visuals with meaningful creativity.",
    buttonText: "Start My Design Project",
  };
