...
export default function InfluencerMarketing() {
  ...
  // 🌟 Hero content
  const heroContent = {
    tag: "Let influencers tell your story.",
    title: "Influencer Marketing",
    subtitle:
      "We connect your brand with the right creators who tell authentic stories. Cube ensures campaigns feel natural, relevant, and drive real results.",
    description:
      "Our influencer marketing experts bridge your brand with creators who resonate with your audience — building trust and engagement through authentic storytelling.",
    features: [
      "Influencer Shortlisting & Management",
  ...
  const whyItMatters = {
    tag: "Why It Matters",
    title: "Influencer Marketing Builds Instant Trust",
    description:
      "Influencer marketing amplifies your brand’s credibility by using relatable, trusted voices. It turns authentic recommendations into measurable engagement and conversions.",
  };
  ...
  const processSteps = [
    {
      ...
      title: "Audit",
      description:
        "Identify influencers who align with your brand’s niche, tone, and target audience values.",
      icon: Search,
    },
    {
      step: "02",
      ...
      description:
        "Develop storytelling frameworks, deliverables, and timelines for smooth collaboration.",
      icon: Target,
    },
    {
      step: "03",
      title: "Execution",
      description:
        "Coordinate influencer outreach, contracts, content approvals, and posting schedules.",
      icon: Users,
    },
    {
      step: "04",
      title: "Optimization",
      description:
        "Monitor live campaign engagement, tweak messaging, and maximize audience response.",
      icon: Activity,
    },
    {
      step: "05",
      title: "Reporting",
      description:
        "Deliver post-campaign insights — impressions, engagement rate, and conversions.",
      icon: FileText,
    },
  ];
  ...
  const whyChooseUs = {
    ...
    points: [
      "Strong influencer network across Bengal and India.",
      "Micro to macro creator partnerships for all budgets.",
      "Cube handles briefing, coordination, and approvals.",
      "ROI and engagement-focused measurement and reporting.",
    ],
  };
  ...
  const caseStudy = {
    ...
    challenge: "Low awareness in the premium saree segment.",
    strategy:
      "Collaborated with top fashion influencers to produce lifestyle-focused Reels and story campaigns.",
    result: "2.5L+ reach and 40% increase in showroom visits within one month.",
  };

  const faqs = [
    {
      q: "Do I choose the influencers?",
      a: "Yes, Cube shortlists the best options for your brand, and you approve the final selection.",
    },
    {
      q: "Can small brands afford this?",
      a: "Absolutely. We offer barter and low-cost influencer campaigns tailored to small brands.",
    },
    {
      q: "How do you measure success?",
      a: "We measure campaign impact through engagement rates, reach, and conversion tracking.",
    },
  ];

  const cta = {
    icon: Sparkles,
    title: "Start Your Next Influencer Campaign",
    subtitle: "Connect your brand with trusted voices through Cube Multimedia.",
