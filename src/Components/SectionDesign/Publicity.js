...
export default function PublicityPRServices() {
  const [isVisible, setIsVisible] = useState(false);
  useEffect(() => setIsVisible(true), []);

  // 🌟 All content centralized here
  const heroContent = {
    tag: "Perception is power.",
    title: "Publicity & PR Services",
    subtitle:
      "Cube Multimedia — Crafting Stories That Make You Visible, Credible & Unforgettable.",
    description:
      "At Cube Multimedia, we build brands that not only shine in the spotlight but also stay in people’s minds — because how the world sees you matters.",
    features: [
      "Brand Visibility",
  ...
  const whyItMatters = {
    tag: "Why It Matters",
    title: "Personal Branding That Builds Influence",
    description:
      "A strong personal brand helps individuals stand out in their field, attract opportunities, and create a lasting impact.",
  };

  const processSteps = [
    {
      step: "01",
      title: "Personality & Goal Analysis",
      description:
        "We begin by understanding your personality, aspirations, and professional goals to align your image with your ambitions.",
      icon: User,
    },
    {
      step: "02",
      title: "Content & PR Strategy Creation",
      description:
        "Our experts create a customized content and PR roadmap designed to elevate your personal brand and attract media attention.",
      icon: FileText,
    },
    {
      step: "03",
      title: "Social Media & Visibility Setup",
      description:
        "We optimize and set up your online presence to ensure consistency and visibility across platforms.",
      icon: Star,
    },
    {
      step: "04",
      title: "Campaign Execution & Collaborations",
      description:
        "From influencer collaborations to media features, we execute campaigns that get you noticed.",
      icon: TrendingUp,
    },
    {
      step: "05",
      title: "Analytics & Reputation Tracking",
      description:
        "We monitor engagement metrics and audience sentiment to ensure your reputation continues to grow.",
      icon: BarChart,
    },
  ];
  ...
  const whyChooseUs = {
    ...
    points: [
      "End-to-end brand image building.",
      "Handled PR and content for top personalities.",
      "Customized positioning strategies.",
    ],
  };
  ...
  const caseStudy = {
    ...
    challenge:
      "Needed a refreshed digital identity and a stronger social media presence.",
    strategy:
      "Developed a storytelling-driven content plan highlighting authentic moments and upcoming projects.",
    result:
      "Significant increase in engagement and an enhanced brand perception across platforms.",
  };

  const faqs = [
    {
      q: "Do you handle personal PR?",
      a: "Yes, we manage both personal and media PR — including interviews, coverage, and online press releases.",
    },
    {
      q: "Can I keep my existing social pages?",
      a: "Absolutely! We optimize and align your existing profiles with your new brand strategy.",
    },
  ];

  const cta = {
    icon: Sparkles,
    title: "Let Your Personality Become Your Brand",
    subtitle: "Build with Cube Multimedia.",
    buttonText: "Start My PR Journey",
  };
          ...
          <div className="flex-1">
            <div className="relative bg-white/95 backdrop-blur-lg text-gray-900 p-8 rounded-3xl shadow-2xl border border-white/20 hover:shadow-rose-500/20 transition-all duration-500">
              ...
              <p className="text-gray-600 text-sm text-center mb-6">
                Your image defines your influence. Cube builds strong personal
                brands that grow authority, recognition, and trust.
              </p>

              <form className="space-y-4">
                {["Email", "Mobile Number", "Profession"].map((ph, i) => (
                  <input
                    key={i}
                    type="text"
                    placeholder={ph}
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-700 to-rose-700">
              How We Shape Your Public Image
            </h2>
          </div>
