...
export default function PodcastProductionMarketing() {
  const [isVisible, setIsVisible] = useState(false);
  useEffect(() => setIsVisible(true), []);

  // 🌟 Hero content
  const heroContent = {
    tag: "Your voice, your story — amplified.",
    title: "Podcast Production & Marketing",
    subtitle:
      "We help you plan, record, and grow your podcast. Cube manages everything from production to audience marketing.",
    description:
      "From studio-quality sound to global reach — Cube Multimedia handles every part of your podcast journey with creative precision and marketing expertise.",
    features: [
      "Concept Development",
      "Audio Editing & Branding",
  ...
  const whyItMatters = {
    tag: "Why It Matters",
    title: "Podcasts Build Connection & Authority",
    description:
      "Podcasts are one of the most authentic ways to engage audiences. They humanize your brand, build authority, and create deep connections with listeners.",
  };

  const processSteps = [
    {
      step: "01",
      title: "Concept Development & Format Setup",
      description:
        "We define your podcast’s theme, audience, tone, and structure to ensure every episode delivers consistent value.",
      icon: PenTool,
    },
    {
      step: "02",
      ...
      description:
        "Our in-house team records, mixes, and masters your episodes using professional-grade tools for crystal-clear sound.",
      icon: Mic2,
    },
    {
      step: "03",
      title: "Visual Branding & Distribution Setup",
      description:
        "We design your cover art, thumbnails, and set up distribution on Spotify, YouTube, and all major podcast platforms.",
      icon: PlayCircle,
    },
    {
      step: "04",
      title: "Social Media Promotion & Ad Support",
      description:
        "We build buzz through clips, reels, and promotional ads to grow your audience and engagement.",
      icon: Megaphone,
    },
    {
      step: "05",
      title: "Reporting & Audience Analytics",
      description:
        "We track listener insights, downloads, and engagement — helping you understand what works best.",
      icon: BarChart3,
    },
  ];
  ...
  const whyChooseUs = {
    ...
    points: [
      "In-house recording and editing setup.",
      "Marketing strategy for audience growth.",
      "Distribution on Spotify, YouTube, and more.",
    ],
  };
  ...
  const caseStudy = {
    ...
    challenge:
      "Needed full production and marketing support for episode launches.",
    strategy:
      "Handled audio editing, visual design, and platform distribution with audience-focused marketing.",
    result: "Reached 50K+ listeners across platforms within 3 months.",
  };

  const faqs = [
    {
      q: "Do you record in-studio?",
      a: "Yes — in our Kolkata studio or remotely via high-quality software sessions.",
    },
    {
      q: "Can you promote my podcast on social media?",
      a: "Absolutely — we create clips, graphics, and ad campaigns to boost visibility and followers.",
    },
  ];
  ...
  const cta = {
    ...
    subtitle:
      "From studio to success — start your journey with Cube Multimedia.",
    buttonText: "Start My Podcast",
  };
          ...
          <div className="flex-1">
            <div className="relative bg-white/95 backdrop-blur-lg text-gray-900 p-8 rounded-3xl shadow-2xl border border-white/20 hover:shadow-rose-500/20 transition-all duration-500">
              ...
              <p className="text-gray-600 text-sm text-center mb-6">
                Plan, record, and promote your podcast — we handle everything.
              </p>

              <form className="space-y-4">
                {["Email", "Podcast Name", "Preferred Genre"].map((ph, i) => (
                  <input
                    key={i}
                    type="text"
                    placeholder={ph}
                ...
                >
                  <span>Request Podcast Plan</span>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-700 to-rose-700">
              How We Bring Your Podcast to Life
            </h2>
          </div>
