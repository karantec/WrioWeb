...
export default function PerformanceManagement() {
  ...
  const heroContent = {
    tag: "Run Ads That Deliver Real Results",
    title: "Performance Marketing (Meta & Google Ads)",
    subtitle:
      "We don’t just run ads — we run results. Cube Multimedia plans, executes, and optimizes high-performing Meta and Google Ads to drive measurable business growth.",
    description:
      "Our performance-driven campaigns combine strategic targeting, creative storytelling, and data analytics to maximize ROI for your brand.",
    features: [
  ...
  const whyItMatters = {
    ...
    description:
      "Performance marketing helps brands grow faster by reaching the right people at the right moment — driving conversions, not just clicks. It’s the foundation of ROI-based digital growth.",
  };
  ...
  const processSteps = [
    {
      ...
      description:
        "We analyze competitors, audience behavior, and current performance data to identify campaign opportunities.",
      icon: BarChart,
    },
    {
      step: "02",
      ...
      description:
        "Our experts build funnel-based ad strategies designed for conversions, not vanity metrics.",
      icon: FileText,
    },
    {
      step: "03",
      title: "Execution",
      description:
        "We launch campaigns across Meta (Facebook, Instagram) and Google Ads with compelling creatives and precision targeting.",
      icon: Sparkles,
    },
    {
      step: "04",
      title: "Optimization",
      description:
        "Daily tracking, A/B testing, and bid adjustments ensure your ads stay efficient and ROI-positive.",
      icon: Check,
    },
    {
      step: "05",
      title: "Reporting",
      description:
        "Receive detailed weekly and monthly performance reports, including lead quality and campaign analytics.",
      icon: BarChart,
    },
  ];
  ...
  const whyChooseUs = {
    ...
    points: [
      "Certified ad specialists managing 50+ active campaigns monthly.",
      "Transparent ad spend and ROI reporting.",
      "Smart targeting for high-quality, verified leads.",
      "Comprehensive funnel planning — from awareness to conversion.",
    ],
  };
  ...
  const caseStudy = {
    ...
    challenge: "High lead cost in a competitive real estate market.",
    strategy:
      "Implemented localized ads with A/B-tested creatives, conversion tracking, and WhatsApp integration for direct inquiries.",
    result:
      "Generated 300+ verified leads in 30 days while reducing cost per lead by 40%.",
  };

  const faqs = [
    {
      q: "What’s the minimum budget?",
      a: "We recommend starting with ₹10,000/month for ad spends to ensure effective optimization and measurable performance.",
    },
    {
      q: "Do you handle both Meta and Google Ads?",
      a: "Yes — our team manages Meta (Facebook & Instagram) and Google Ads depending on your campaign goals.",
    },
    {
      q: "Can I monitor my campaign performance?",
      a: "Absolutely — you’ll receive weekly reports and access to your analytics dashboard for real-time insights.",
    },
  ];

  const cta = {
    icon: Sparkles,
    title: "Run Campaigns That Sell, Not Just Reach",
    subtitle:
      "Book a performance strategy call with Cube Multimedia and start driving real ROI today.",
